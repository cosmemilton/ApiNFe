...
const WORKSPACE = {
	WITH_USER: lazy(() => import('../pages/presentation/workspace/WorkspacesUser')),
	ISSUER: lazy(() => import('../pages/presentation/workspace/IssuersWorkspaces')),
};
...
const presentation: RouteProps[] = [
	...
	/** ************************************************** */
	{
		path: demoPagesMenu.listWorkspaces.subMenu.listWorkspacesUser.path,
		element: <WORKSPACE.WITH_USER />,
	},
	{
		path: demoPagesMenu.listWorkspaces.subMenu.listIssuersWorkspaces.path,
		element: <WORKSPACE.ISSUER />,
	},
