...
const WorkspacesUserEvents: FC<ICommonUpcomingEventsProps> = ({ isFluid }) => {
		...
		<>
			<Card stretch={isFluid}>
				<CardHeader borderSize={1}>
					<CardLabel icon='Workspaces' iconColor='info'>
						<CardTitle>Lista de Workspace</CardTitle>
					</CardLabel>
					<CardActions>
						<Button
							color='info'
...
export default WorkspacesUserEvents;
